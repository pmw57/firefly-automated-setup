...
export const CRIME_STORIES: StoryCardDef[] = [
  {
    title: STORY_TITLES.SMUGGLERS_BLUES,
    ...
    rules: createStoryRules(STORY_TITLES.SMUGGLERS_BLUES, [
  ...
  },
  {
    ...
    requiredExpansion: "crime",
    rules: createStoryRules(STORY_TITLES.WANTED_MEN, [
