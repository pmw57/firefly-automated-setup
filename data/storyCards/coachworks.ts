...
export const COACHWORKS_STORIES: StoryCardDef[] = [
  {
    title: STORY_TITLES.DOWN_AND_OUT,
    ...
    rules: createStoryRules(STORY_TITLES.DOWN_AND_OUT, [
  ...
  {
    title: STORY_TITLES.WHERE_THE_WIND_TAKES_US,
    ...
    requiredExpansion: "coachworks",
    rules: createStoryRules(STORY_TITLES.WHERE_THE_WIND_TAKES_US, [
