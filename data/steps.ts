...
export const STEP_QUOTES: { [key: string]: { text: string; author: string } } = {
  ...
  'C2': { text: "If they take the ship, they'll rape us to death, eat our flesh, and sew our skins into their clothing. And if we're lucky, they'll do it in that order.", author: "Zoë Washburne" },
  'C3': { text: "Love. You can learn all the math in the 'Verse, but you take a boat in the air that you don't love, she'll shake you off just as sure as the turning of the worlds.", author: "Mal Reynolds" },
  ...
  'C6': { text: "I do the job, then I get paid.", author: "Mal Reynolds" },
  'C_PRIME': { text: "Everything's shiny, Cap'n. Not to fret.", author: "Kaylee Frye" },
  'D_RIM_JOBS': { text: "So here is us, on the raggedy edge. Don't push me, and I won't push you. Dong le ma?", author: "Mal Reynolds" },
  ...
  'D_LOCAL_HEROES': { text: "First time we ever sailed with a cargo of big damn heroes.", author: "Zoë Washburne" },
