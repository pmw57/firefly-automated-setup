...
describe('Setup Cards Step Regression', () => {
  const expectedSteps: Record<string, string[]> = {
    ...
    [SETUP_CARD_IDS.THE_BROWNCOAT_WAY]: [STEP_IDS.C4, STEP_IDS.C1, STEP_IDS.C2, STEP_IDS.D_BC_CAPITOL, STEP_IDS.C3, STEP_IDS.C6, STEP_IDS.C_PRIME],
    [SETUP_CARD_IDS.THE_BLITZ]: [STEP_IDS.C4, STEP_IDS.C1, STEP_IDS.C2, STEP_IDS.C3, STEP_IDS.D_STRIP_MINING, STEP_IDS.C6, STEP_IDS.C_PRIME],
    ...
    [SETUP_CARD_IDS.FLYING_SOLO]: [STEP_IDS.C4, STEP_IDS.C1, STEP_IDS.C2, STEP_IDS.C3, STEP_IDS.C5, STEP_IDS.C6, STEP_IDS.C_PRIME, STEP_IDS.D_GAME_LENGTH_TOKENS],
    [SETUP_CARD_IDS.AINT_ALL_BUTTONS_AND_CHARTS]: [STEP_IDS.C4, STEP_IDS.C1, STEP_IDS.C2, STEP_IDS.C3, STEP_IDS.D_SHUTTLE, STEP_IDS.C5, STEP_IDS.C6, STEP_IDS.C_PRIME],
    [SETUP_CARD_IDS.HOME_SWEET_HAVEN]: [STEP_IDS.C4, STEP_IDS.C1, STEP_IDS.C2, STEP_IDS.D_HAVEN_DRAFT, STEP_IDS.C5, STEP_IDS.C6, STEP_IDS.C_PRIME, STEP_IDS.D_LOCAL_HEROES],
