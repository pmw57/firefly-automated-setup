...
export interface AddSpecialRule extends BaseRule { type: 'addSpecialRule'; category: 'jobs' | 'allianceReaver' | 'draft' | 'nav' | 'prime' | 'resources' | 'soloTimer' | 'goal' | 'draft_panel' | 'draft_ships' | 'draft_placement' | 'prime_panel' | 'setup_selection' | 'pressures_high' | 'story_override'; rule: Omit<SpecialRule, 'source'>; }
