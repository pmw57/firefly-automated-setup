 ...
 */
// Fix: The `ErrorBoundary` class must extend `React.Component` to be a valid class component. This provides access to component lifecycle methods, state, and props.
