...
export const OptionalRulesSelection: React.FC<OptionalRulesSelectionProps> = ({ gameState, setGameState, onBack, onStart }) => {
            ...
            {has10th && (
                <section>
                    ...
                    <div 
                        ...
                        className={`flex items-start p-4 rounded-lg border cursor-pointer transition-colors ${optionBorder} ${optionHover} mb-4`}
                    >
