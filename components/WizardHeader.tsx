...
export const WizardHeader = ({ gameState, onReset, flow, currentStepIndex }: WizardHeaderProps): React.ReactElement => {
    ...
    return (
        <div className={`${stickyHeaderBg} backdrop-blur-sm p-4 rounded-lg mb-6 shadow-sm border flex flex-col sm:flex-row justify-between items-center transition-all duration-300 sticky top-0 z-30 min-h-[88px] gap-4`}>
