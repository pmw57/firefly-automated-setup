...
export const getJobSetupDetails = (gameState: GameState, overrides: StepOverrides): JobSetupDetails => {
    ...
    return { contacts, messages, showStandardContactList: true, isSingleContactChoice, cardsToDraw: 3, totalJobCards: contacts.length, caperDrawCount, isContactListOverridden, jobDrawMode, isSharedHandMode };
};